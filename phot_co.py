...
#   MODIFIED BY MANKEUN JEONG (19.08.14.)

#   THE PROGRAMS REQUIRED: SEXTRACTOR, PSFEXTRACTOR, imcopy, photutils
#=========================================================================#
...
def image_list(imlist):
	...
	fillist = []
	for img in imlist:
		sp  = img.split('-') #img file name should be in the form of xxx-xxx(obs)-xxx(obj)-xxx-xxx-xxx(filter)-xxx
		obslist.append(sp[1])
		objlist.append(sp[2])
		fillist.append(sp[5])
...
def secom(inim, gain, pixscale, zp=0, seeing=3, det_sigma=3, backsize=str(64), backfiltersize=str(3), psf=False, dual=False, detect='detection.fits', check=False):
	...
	configfile      = '/home/sonic/research/photometry/config/targetphot.sex'
	paramfile       = '/home/sonic/research/photometry/config/targetphot.param'
	nnwfile		    = '/home/sonic/research/photometry/config/targetphot.nnw'
	convfile	    = '/home/sonic/research/photometry/config/targetphot.conv'
	try:
...
def psfex(inim, pixscale):
	...
	#   FILE CHECK
	#	CONFIG FILES (USER BASE PATH)
	psfexconf_prese_conf    = '/home/sonic/research/photometry/config/prepsfex.sex'
	psfexconf_prese_param   = '/home/sonic/research/photometry/config/prepsfex.param'
	psfexconf_psfex_conf    = '/home/sonic/research/photometry/config/default.psfex'
	psfexconf_psfex_conv    = '/home/sonic/research/photometry/config/default.conv'
	try:
		comment = '\nPSFex START\n' \
				+ 'IMAGE\t\t: '+inim+'\n' \
...
def sdss_Blanton(intbl, name):
	...
	OUTPUT  :   1.  ONLY STAR CLASS (=6)
				...
				3.  NAME, RA, Dec, ugriz, BVRI [AB] (Blanton+07), clean
				sdss-conv.cat
	---------------------------------------------------------------------
	Blanton+07
...
def ps1_Tonry(intbl, name):
	...
	Ver	    = sqsum( Vsig, sqsum(B1*grer, intbl['e_rmag']) )
	#	CONVERT TO R
	B0		=-0.138
	B1		=-0.131
