...
#   MODIFIED 2019.08.09 MANKEUN JEONG
#============================================================
import os, glob
import numpy as np
...
#	FUNCTION
#============================================================
def phot_routine(inim, refcatname, phottype, tra, tdec, path_base='./', aperture='MAG_APER_7', detsig=3.0, frac=0.5):
	#------------------------------------------------------------
	#	HEADER INFO
	...
	#------------------------------------------------------------
	#	NAME INFO
	obs, obj		= 'ELSAUCE', 'NGC2207'    # observatory and target
	refmagkey		= hdr['FILTER']
	refmagerkey 	= refmagkey+'err'
	gain, pixscale	= 1.5, 2.35         # RASA36
...
#============================================================
path_base	= './'
path_obs	= '/home/sonic/research/photometry/table'
path_refcat	= '/home/sonic/research/photometry/cat/refcat'
#------------------------------------------------------------
#obstbl		= ascii.read(path_obs+'/obs.txt')
#	TARGET COORD.	[deg]

tra, tdec	= 188.0207083,	-10.9334722	#	GRB150101B
#tra, tdec	= 279.9748667,	62.392875	#	GRB160821B
#tra, tdec	= 197.44875,	-23.3838889	#	GRB170817A
#tra, tdec	= 152.305620,	-26.630920	#	GRB150424AA
#tra, tdec	= 94.091,	-21.372	#	NGC2207
#------------------------------------------------------------
